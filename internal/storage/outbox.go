...
type OutboxRepository interface {
	CreateNotificationTripPublishTx(ctx context.Context, tx pgx.Tx, o *domain.Entity) error
}
...
func (r *OutboxEventRepository) CreateNotificationTripPublishTx(ctx context.Context, tx pgx.Tx, o *domain.Entity) error {
